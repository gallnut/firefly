...
try:
    ...
    print(
        "Please generate python grpc stubs first: python -m grpc_tools.protoc -I../proto --python_out=. --grpc_python_out=. ../proto/firefly.proto"
    )
    sys.exit(1)
...
def run():
    with grpc.insecure_channel("localhost:50051") as channel:
        ...
        request = firefly_pb2.ChatCompletionRequest(model="qwen3", max_tokens=2048)
